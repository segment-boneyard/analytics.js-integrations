/*
 * Modified version of https://github.com/rollbar/rollbar.js/blob/v1.1.7/dist/rollbar.snippet.js
 *
 * Changes include:
 * - Pass in config
 * - Do not pass in document
 * - Do not call loadFull()
 * - Return the initialized Rollbar instance
 *
 */
module.exports = function(window, config) {
  ...
  config.rollbarJsUrl = config.rollbarJsUrl || defaultRollbarJsUrl;
