...
var waitForWidgets = function(cb, attempts){
  ...
  if ((attempts < 2) || (document.querySelector('[id^="extole-advocate-widget"]') &&
  document.querySelector('[id^="easyXDM_cloudsponge"]') &&
  document.querySelector('#cs_container') &&
  document.querySelector('#cs_link'))) {
