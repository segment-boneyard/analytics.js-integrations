...
Outbound.prototype.identify = function(identify){
  var userAttributes = function(identify){
    var body = {
      user_id: identify.traits().id,
      attributes: identify.traits(),
      email: identify.traits().email,
      phone_number: identify.traits().phone,
      first_name: identify.traits().firstName,
      last_name: identify.traits().lastName
    };
  ...
  outbound.identify(identify.traits().id, userAttributes(identify));
};
