...
describe('KISSmetrics', function(){
  ...
  before(function (done) {
    ...
    test = tester(kissmetrics).stub(kissmetrics, 'load');
  });
  ...
  describe('#page', function(){
    ...
    it('should track named pages by default', function(){
      test
        ...
        .called(window._kmq.push, 'record', 'Viewed Name Page', {
  ...
  describe('#track', function(){
    ...
    it('should send an event', function(){
      test
        .track('event')
        .called(window._kmq.push, 'record', 'event', {});
    });
  ...
  describe('#alias', function(){
    ...
    it('should send a new id', function(){
      test
        .alias('new')
        .called(window._kmq.push, 'alias', 'new', undefined);
    });

    it('should send a new and old id', function(){
      test
        .alias('new', 'old')
        .called(window._kmq.push, 'alias', 'new', 'old');
    });
  });
  ...
  describe('ecommerce', function(){
    beforeEach(function(){
      test
        .initialize()
        .spy(window.KM, 'set')
        .spy(window.KM, 'ts', Function('return 0'))
        .spy(window._kmq, 'push')
    });
    ...
    it('should track viewed product', function(){
      test
        ...
        .called(window._kmq.push, 'record', 'viewed product', {
    ...
    it('should track added product', function(){
      test
        ...
        .called(window._kmq.push, 'record', 'added product', {
          'added product - sku': 1,
    ...
    it('should track completed order', function(){
      test
        ...
        .called(window._kmq.push.args[0], 'record', 'completed order', {
