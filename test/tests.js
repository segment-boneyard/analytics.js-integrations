...
require('../lib/atatus/test.js');
require('../lib/autosend/test.js');
require('../lib/awesm/test.js');
require('../lib/bing-ads/test.js');
require('../lib/blueshift/test.js');
...
require('../lib/satismeter/test.js');
require('../lib/segmentio/test.js');
